...
function RetaguardaDashboardContent() {
  ...
  const [acessosManuais, setAcessosManuais] = useState(0);
  ...
  const carregarAssinaturas = async () => {
    ...
    try {
      ...
      setAcessosManuais(r.acessos_manuais ?? 0);
      ...
      <div className="flex flex-col h-full p-6 space-y-6 overflow-auto">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className={`text-sm mt-1 ${sub}`}>
              Apenas clientes com cobrança real na Asaas.
              {acessosManuais > 0 && ` ${acessosManuais} acesso(s) manual(is) (gestores/cortesias) não aparecem aqui.`}
            </p>
          </div>
          <button
